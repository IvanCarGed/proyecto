...
function agni_iconpicker_type_iconlist( $icons ) {
	$icon_list_array = array(
		...
		'Medical Icons' => array(
			array( 'wfmi-accessibility'  => 'accessibility' ),
			array( 'wfmi-administration'  =>    'administration' ),
			array( 'wfmi-alternative-complementary'  => 'alternative-complementary' ),
			array( 'wfmi-ambulance'  => 'ambulance' ),
			array( 'wfmi-anesthesia'  =>    'anesthesia' ),
			array( 'wfmi-billing'  =>   'billing' ),
			array( 'wfmi-cardiology'  =>    'cardiology' ),
			array( 'wfmi-care-staff-area'  =>   'care-staff-area' ),
			array( 'wfmi-cath-lab'  =>  'cath-lab' ),
			array( 'wfmi-chapel'  =>    'chapel' ),
			array( 'wfmi-coffee-shop'  =>   'coffee-shop' ),
			array( 'wfmi-dental'  =>    'dental' ),
			array( 'wfmi-dermatology'  =>   'dermatology' ),
			array( 'wfmi-diabetes-education'  =>    'diabetes-education' ),
			array( 'wfmi-drinking-fountain'  => 'drinking-fountain' ),
			array( 'wfmi-ear-nose-throat'  =>   'ear-nose-throat' ),
			array( 'wfmi-elevators'  => 'elevators' ),
			array( 'wfmi-emergency'  => 'emergency' ),
			array( 'wfmi-family-practice'  =>   'family-practice' ),
			array( 'wfmi-fire-extinguisher'  => 'fire-extinguisher' ),
			array( 'wfmi-first-aid'  => 'first-aid' ),
			array( 'wfmi-genetics'  =>  'genetics' ),
			array( 'wfmi-gift-shop'  => 'gift-shop' ),
			array( 'wfmi-health-education'  =>  'health-education' ),
			array( 'wfmi-health-services'  =>   'health-services' ),
			array( 'wfmi-hearing-assistance'  =>    'hearing-assistance' ),
			array( 'wfmi-hospital'  =>  'hospital' ),
			array( 'wfmi-i-accessibility'  =>   'i-accessibility' ),
			array( 'wfmi-i-administration'  =>  'i-administration' ),
			array( 'wfmi-i-alternative-complementary'  =>   'i-alternative-complementary' ),
			array( 'wfmi-i-ambulance'  =>   'i-ambulance' ),
			array( 'wfmi-i-anesthesia'  =>  'i-anesthesia' ),
			array( 'wfmi-i-billing'  => 'i-billing' ),
			array( 'wfmi-i-cardiology'  =>  'i-cardiology' ),
			array( 'wfmi-i-care-staff-area'  => 'i-care-staff-area' ),
			array( 'wfmi-i-cath-lab'  =>    'i-cath-lab' ),
			array( 'wfmi-i-chapel'  =>  'i-chapel' ),
			array( 'wfmi-i-coffee-shop'  => 'i-coffee-shop' ),
			array( 'wfmi-i-dental'  =>  'i-dental' ),
			array( 'wfmi-i-dermatology'  => 'i-dermatology' ),
			array( 'wfmi-i-diabetes-education'  =>  'i-diabetes-education' ),
			array( 'wfmi-i-drinking-fountain'  =>   'i-drinking-fountain' ),
			array( 'wfmi-i-ear-nose-throat'  => 'i-ear-nose-throat' ),
			array( 'wfmi-i-elevators'  =>   'i-elevators' ),
			array( 'wfmi-i-emergency'  =>   'i-emergency' ),
			array( 'wfmi-i-family-practice'  => 'i-family-practice' ),
			array( 'wfmi-i-fire-extinguisher'  =>   'i-fire-extinguisher' ),
			array( 'wfmi-i-first-aid'  =>   'i-first-aid' ),
			array( 'wfmi-i-genetics'  =>    'i-genetics' ),
			array( 'wfmi-i-gift-shop'  =>   'i-gift-shop' ),
			array( 'wfmi-i-health-education'  =>    'i-health-education' ),
			array( 'wfmi-i-health-services'  => 'i-health-services' ),
			array( 'wfmi-i-hearing-assistance'  =>  'i-hearing-assistance' ),
			array( 'wfmi-i-hospital'  =>    'i-hospital' ),
			array( 'wfmi-i-imaging-alternative-ct'  =>  'i-imaging-alternative-ct' ),
			array( 'wfmi-i-imaging-alternative-mri-two'  => 'i-imaging-alternative-mri-two' ),
			array( 'wfmi-i-imaging-alternative-mri'  => 'i-imaging-alternative-mri' ),
			array( 'wfmi-i-imaging-alternative-pet'  => 'i-imaging-alternative-pet' ),
			array( 'wfmi-i-imaging-root-category'  =>   'i-imaging-root-category' ),
			array( 'wfmi-i-immunizations'  =>   'i-immunizations' ),
			array( 'wfmi-i-infectious-diseases'  => 'i-infectious-diseases' ),
			array( 'wfmi-i-information-us'  =>  'i-information-us' ),
			array( 'wfmi-i-inpatient'  =>   'i-inpatient' ),
			array( 'wfmi-i-intensive-care'  =>  'i-intensive-care' ),
			array( 'wfmi-i-internal-medicine'  =>   'i-internal-medicine' ),
			array( 'wfmi-i-interpreter-services'  =>    'i-interpreter-services' ),
			array( 'wfmi-i-kidney'  =>  'i-kidney' ),
			array( 'wfmi-i-labor-delivery'  =>  'i-labor-delivery' ),
			array( 'wfmi-i-laboratory'  =>  'i-laboratory' ),
			array( 'wfmi-i-mammography'  => 'i-mammography' ),
			array( 'wfmi-i-medical-library'  => 'i-medical-library' ),
			array( 'wfmi-i-medical-records'  => 'i-medical-records' ),
			array( 'wfmi-i-mental-health'  =>   'i-mental-health' ),
			array( 'wfmi-i-mri-pet'  => 'i-mri-pet' ),
			array( 'wfmi-i-neurology'  =>   'i-neurology' ),
			array( 'wfmi-i-no-smoking'  =>  'i-no-smoking' ),
			array( 'wfmi-i-nursery'  => 'i-nursery' ),
			array( 'wfmi-i-nutrition'  =>   'i-nutrition' ),
			array( 'wfmi-i-oncology'  =>    'i-oncology' ),
			array( 'wfmi-i-ophthalmology'  =>   'i-ophthalmology' ),
			array( 'wfmi-i-outpatient'  =>  'i-outpatient' ),
			array( 'wfmi-i-pathology'  =>   'i-pathology' ),
			array( 'wfmi-i-pediatrics'  =>  'i-pediatrics' ),
			array( 'wfmi-i-pharmacy'  =>    'i-pharmacy' ),
			array( 'wfmi-i-physical-therapy'  =>    'i-physical-therapy' ),
			array( 'wfmi-i-radiology'  =>   'i-radiology' ),
			array( 'wfmi-i-registration'  =>    'i-registration' ),
			array( 'wfmi-i-respiratory'  => 'i-respiratory' ),
			array( 'wfmi-i-restaurant'  =>  'i-restaurant' ),
			array( 'wfmi-i-restrooms'  =>   'i-restrooms' ),
			array( 'wfmi-i-smoking'  => 'i-smoking' ),
			array( 'wfmi-i-social-services'  => 'i-social-services' ),
			array( 'wfmi-i-stairs'  =>  'i-stairs' ),
			array( 'wfmi-i-surgery'  => 'i-surgery' ),
			array( 'wfmi-i-text-telephone'  =>  'i-text-telephone' ),
			array( 'wfmi-i-ultrasound'  =>  'i-ultrasound' ),
			array( 'wfmi-i-volume-control'  =>  'i-volume-control' ),
			array( 'wfmi-i-waiting-area'  =>    'i-waiting-area' ),
			array( 'wfmi-imaging-alternative-ct'  =>    'imaging-alternative-ct' ),
			array( 'wfmi-imaging-alternative-mri-two'  =>   'imaging-alternative-mri-two' ),
			array( 'wfmi-imaging-alternative-mri'  =>   'imaging-alternative-mri' ),
			array( 'wfmi-imaging-alternative-pet'  =>   'imaging-alternative-pet' ),
			array( 'wfmi-imaging-root-category'  => 'imaging-root-category' ),
			array( 'wfmi-immunizations'  => 'immunizations' ),
			array( 'wfmi-infectious-diseases'  =>   'infectious-diseases' ),
			array( 'wfmi-information-us'  =>    'information-us' ),
			array( 'wfmi-inpatient'  => 'inpatient' ),
			array( 'wfmi-intensive-care'  =>    'intensive-care' ),
			array( 'wfmi-internal-medicine'  => 'internal-medicine' ),
			array( 'wfmi-interpreter-services'  =>  'interpreter-services' ),
			array( 'wfmi-kidney'  =>    'kidney' ),
			array( 'wfmi-labor-delivery'  =>    'labor-delivery' ),
			array( 'wfmi-laboratory'  =>    'laboratory' ),
			array( 'wfmi-mammography'  =>   'mammography' ),
			array( 'wfmi-medical-library'  =>   'medical-library' ),
			array( 'wfmi-medical-records'  =>   'medical-records' ),
			array( 'wfmi-mental-health'  => 'mental-health' ),
			array( 'wfmi-mri-pet'  =>   'mri-pet' ),
			array( 'wfmi-neurology'  => 'neurology' ),
			array( 'wfmi-no-smoking'  =>    'no-smoking' ),
			array( 'wfmi-nursery'  =>   'nursery' ),
			array( 'wfmi-nutrition'  => 'nutrition' ),
			array( 'wfmi-oncology'  =>  'oncology' ),
			array( 'wfmi-ophthalmology'  => 'ophthalmology' ),
			array( 'wfmi-outpatient'  =>    'outpatient' ),
			array( 'wfmi-pathology'  => 'pathology' ),
			array( 'wfmi-pediatrics'  =>    'pediatrics' ),
			array( 'wfmi-pharmacy'  =>  'pharmacy' ),
			array( 'wfmi-physical-therapy'  =>  'physical-therapy' ),
			array( 'wfmi-radiology'  => 'radiology' ),
			array( 'wfmi-registration'  =>  'registration' ),
			array( 'wfmi-respiratory'  =>   'respiratory' ),
			array( 'wfmi-restaurant'  =>    'restaurant' ),
			array( 'wfmi-restrooms'  => 'restrooms' ),
			array( 'wfmi-smoking'  =>   'smoking' ),
			array( 'wfmi-social-services'  =>   'social-services' ),
			array( 'wfmi-stairs'  =>    'stairs' ),
			array( 'wfmi-surgery'  =>   'surgery' ),
			array( 'wfmi-text-telephone'  =>    'text-telephone' ),
			array( 'wfmi-ultrasound'  =>    'ultrasound' ),
			array( 'wfmi-volume-control'  =>    'volume-control' ),
			array( 'wfmi-waiting-area'  =>  'waiting-area' ),
			array( 'wfmi-womens-health'  => 'womens-health' ),
		)
	);
