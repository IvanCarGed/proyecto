...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		_doing_it_wrong( 'WP_REST_Controller::register_routes', esc_html__( 'The register_routes() method must be overriden', 'cmb2' ), 'WPAPI-2.0' );
	}
	...
	public function get_items_permissions_check( $request ) {
		return new WP_Error( 'invalid-method', sprintf( wp_kses( __( "Method '%s' not implemented. Must be over-ridden in subclass.", 'cmb2' ) ), __METHOD__ ), array( 'status' => 405 ) );
	}
	...
	public function get_collection_params() {
		return array(
			...
			'page'                   => array(
				'description'        => esc_html__( 'Current page of the collection.', 'cmb2' ),
				'type'               => 'integer',
				'default'            => 1,
			...
			'per_page'               => array(
				'description'        => esc_html__( 'Maximum number of items to be returned in result set.', 'cmb2' ),
				'type'               => 'integer',
				'default'            => 10,
				'minimum'            => 1,
				'maximum'            => 100,
			...
			'search'                 => array(
				'description'        => esc_html__( 'Limit results to those matching a string.', 'cmb2' ),
				'type'               => 'string',
	...
	public function get_context_param( $args = array() ) {
		$param_details = array(
			'description'        => esc_html__( 'Scope under which the request is made; determines fields present in response.', 'cmb2' ),
			'type'               => 'string',
