 ...
 * @version   2.6.1 Development branch for parent theme Fortun for publication on ThemeForest
	...
	class TGM_Plugin_Activation {
		...
		public function load_textdomain() {
			...
			if ( false !== strpos( __FILE__, WP_PLUGIN_DIR ) || false !== strpos( __FILE__, WPMU_PLUGIN_DIR ) ) {
				...
				load_theme_textdomain( 'tgmpa', get_stylesheet_directory() . '/languages' );
			...
			foreach ( $this->view_totals as $type => $count ) {
				...
				switch ( $type ) {
					case 'all':
						...
						$text = wp_kses( _nx( 'All <span class="count">(%s)</span>', 'All <span class="count">(%s)</span>', $count, 'plugins', 'tgmpa' ), array( 'span' => array() ) );
						break;
					case 'install':
						/* translators: 1: number of plugins. */
						$text = wp_kses( _n( 'To Install <span class="count">(%s)</span>', 'To Install <span class="count">(%s)</span>', $count, 'tgmpa' ), array( 'span' => array() ) );
						break;
					case 'update':
						/* translators: 1: number of plugins. */
						$text = wp_kses( _n( 'Update Available <span class="count">(%s)</span>', 'Update Available <span class="count">(%s)</span>', $count, 'tgmpa' ), array( 'span' => array() ) );
						break;
					case 'activate':
						/* translators: 1: number of plugins. */
						$text = wp_kses( _n( 'To Activate <span class="count">(%s)</span>', 'To Activate <span class="count">(%s)</span>', $count, 'tgmpa' ), array( 'span' => array() ) );
						break;
					default:
						$text = '';
						break;
